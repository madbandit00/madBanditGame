        ...
        element.on('click', function (event) {
            ...
            if (event.target.name === 'loginButton')
            {
                ...
                if (inputUsername.value !== '' && inputPassword.value !== '')
                {
                    ...
                    this.scene.tweens.add({ targets: element, scaleX: 2, scaleY: 2, y: 300, duration: 0, ease: 'Power3',
                        onComplete: function ()
                        {
                ...
                {
                    //  Flash the prompt
                    this.scene.tweens.add({ targets: text, alpha: 0.1, duration: 0, ease: 'Power3', yoyo: true });
                }
            }

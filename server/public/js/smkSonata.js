class SMKSonata extends Phaser.Scene {
    ...
    this.redScoreText = this.add.text(1150, 16, '', { fontSize: '32px', fill: '#FF0000' });
    ...
    let specialMove = this.add.text(50, 100, "Special Move").setFontSize(40).setColor('#808080').setInteractive();
